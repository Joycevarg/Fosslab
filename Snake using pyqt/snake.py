...
class Snake(QtGui.QWidget):
	...
	def scoreBoard(self, qp):
		...
		qp.setBrush(QtGui.QColor(25, 80, 60, 160))
		qp.drawRect(0,976, 1000, 24)

	def scoreText(self, event, qp):
		qp.setPen(QtGui.QColor(255, 255, 255))
		qp.setFont(QtGui.QFont('Decorative', 10))
		qp.drawText(8, 990, "SCORE: " + str(self.score))  
		qp.drawText(895, 990, "HIGHSCORE: " + str(self.highscore))  
	...
	def gameOver(self, event, qp):
		...
		qp.drawText(350, 525 , "press space to play again")    

	def checkStatus(self, x, y):
		if y > 964 or x > 988 or x < 2 or y < 2:
			self.pause()
			self.isPaused = True
			self.isOver = True
			return False
